                                    ...
                                    <div class="radio-list">
                                        <div class="radio-inline pl-0">
                                            <span class="radio radio-info">
                                                <input type="radio" name="chooseBelongsTo[]" id="radio_5"
                                                       value="consultant">
                                        ...
                                        <div class="radio-inline">
                                            <span class="radio radio-info">
                                                <input type="radio" name="chooseBelongsTo[]" id="radio_6"
                                                       value="contractor">
                                        ...
                                        <div class="radio-inline">
                                            <span class="radio radio-info">
                                                <input type="radio" name="chooseBelongsTo[]" id="radio_7" value="owner">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-mobile fa-lg"></i></div>
                                        <input type="text" value="{{old('phone')}}" class="form-control" name="phone2"
                                               placeholder="رقم الهاتف">
                                    </div>
                                </div>
                            </div>
