            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form method="post" action="{{route('engineer-types.store')}}">
                                {{csrf_field()}}
                                ...
                                <div class="form-group mb-30">
                                    ...
                                    <div class="checkbox checkbox-primary">
                                        <input id="checkbox1" type="checkbox" value="1" name="add">
                                        <label for="checkbox1">
                                            اضافة
                                        </label>
                                    </div>
                                    <div class="checkbox checkbox-primary">
                                        <input id="checkbox2" type="checkbox" value="1" name="edit">
                                        <label for="checkbox2">
                                            تعديل
                                        </label>
                                    </div>
                                    <div class="checkbox checkbox-primary">
                                        <input id="checkbox3" type="checkbox" value="1" name="delete">
                                        <label for="checkbox3">
                                            حذف
                                        </label>
                                    </div>
