        ...
        <div class="panel panel-default card-view">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-3">{{$consultant->name}}</div>
                    <div class="col-md-3">الاميل</div>
                    <div class="col-md-3">{{$consultant->email}}</div>
                </div>
                <div class="row">
                    <div class="col-md-3">عنوان المراسلات</div>
                    <div class="col-md-3">{{$consultant->information->address}}</div>
                    <div class="col-md-3">رقم الهاتف</div>
                    <div class="col-md-3">{{$consultant->information->phone}}</div>
                </div>
                <div class="row">
                    <div class="col-md-3">الموقع</div>
                    <div class="col-md-3">{{$consultant->information->location}}</div>
                    <div class="col-md-3">الموقع الالكتروني</div>
                    <div class="col-md-3">{{$consultant->information->website}}</div>
                </div>
            </div>
        </div>
    </div>
