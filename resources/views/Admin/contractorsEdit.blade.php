    ...
    <div class="row arabic-fonts">
        <div class="panel panel-default card-view">
            <div class="panel-body">
                <div class="form-wrap">
                    <form method="post" action="{{route('contractors.update',['id'=>$contractor->id])}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group{!! $errors->has('name')?" has-error":null !!}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$contractor->name}}"
                                               name="name"
                            ...
                            <div class="col-md-4">
                                <div class="form-group{!! $errors->has('email')?" has-error":null !!}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" value="{{$contractor->email}}" class="form-control"
                                               name="email"
                            ...
                            <div class="col-md-4">
                                <div class="form-group{!! $errors->has('address')?" has-error":null !!}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{$contractor->information->address}}"
                                               class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group {!! $errors->has('phone')?" has-error":null !!}">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="icon-user"></i></div>
                                        <input type="text" value="{{$contractor->information->phone}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="icon-user"></i></div>
                                        <input type="text" value="{{$contractor->information->phone2}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group{!! $errors->has('emergency-phone')?" has-error":null !!}">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="icon-user"></i></div>
                                        <input type="number" value="{{$contractor->information->emergency_phone}}"
                                               class="form-control"
