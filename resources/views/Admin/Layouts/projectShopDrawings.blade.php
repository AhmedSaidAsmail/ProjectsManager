                                        ...
                                        <div class="ibox-content">
                                            <div class="file-manager">
                                                <div class="mt-20 mb-20 ml-15 mr-15">
                                                    @if(in_array(auth()->user()->permission->contractorPermissions->shop_drawings,[7]) || auth()->guard('web')->check())
                                                        <div class="modal fade" id="uploud_new_sopdrowingplan_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                        <h5 class="modal-title" id="">رفع مخططات رسومات الورشه</h5>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form action="{{route('shops-drawings.store')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <button class="btn btn-success btn-rounded btn-block btn-anim" data-toggle="modal" data-target="#uploud_new_sopdrowingplan_model" data-whatever="@"><i class="fa fa-pencil"></i><span
                                                                        class="btn-text">رفع مخطط ورشه جديد</span></button>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="pl-15 mb-30">
                                                    <a href="{{route('shops-drawings.index')}}?project_id={{$project->id}}&sort=architectural" data-display="#project-shopsDrawing" class="file-control active ajax-data">المعماري</a>
                                                    <a href="{{route('shops-drawings.index')}}?project_id={{$project->id}}&sort=structural" data-display="#project-shopsDrawing" class="file-control ajax-data">الانشائي</a>
                                                    <a href="{{route('shops-drawings.index')}}?project_id={{$project->id}}&sort=mechanics" data-display="#project-shopsDrawing" class="file-control ajax-data">الميكانيكا</a>
                                                    <a href="{{route('shops-drawings.index')}}?project_id={{$project->id}}&sort=electrically" data-display="#project-shopsDrawing" class="file-control ajax-data">الكهرباء</a>
                                                    <a href="{{route('shops-drawings.index')}}?project_id={{$project->id}}&sort=general" data-display="#project-shopsDrawing" class="file-control ajax-data">الموقع العام</a>
                                                </div>
                                                <h6 class="pl-15 mb-10">بحث</h6>
                                                <ul class="tag-list pl-15 pr-15">
                                                    <form action="{{route('shops-drawings.index')}}" method="get" id="ajax-data" data-display="#project-shopsDrawing">
                                                        <input type="hidden" name="project_id" value="{{$project->id}}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="table-wrap">
                                                    <div class="table-responsive" id="project-shopsDrawing">
