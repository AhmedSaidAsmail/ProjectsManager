                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select name="sort" class="form-control" data-placeholder="اختر واحده" tabindex="1">
                                                                                ...
                                                                                <option value="اعتماد عينه">اعتماد عينه</option>
                                                                                <option value="اعتماد مخططات الورشه">اعتماد مخططات الورشه</option>
                                                                                <option value="اعتماد موردين">اعتماد موردين</option>
                                                                                <option value="اعتماد مقاول باطن">اعتماد مقاول باطن</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="ibox-content">
                                                                        <div class="file-manager">
                                                                            <div class="mt-20 mb-20 ml-15 mr-15">
                                                                                ...
                                                                                <div>
                                                                                    <button class="btn btn-success btn-rounded btn-block btn-anim" data-toggle="modal" data-target="#uploud_new_change_order_model" data-whatever="@"><i class="fa fa-pencil"></i><span
                                                                                                class="btn-text">رفع امر تغيير جديد</span></button>
                                                                                </div>
                                                                            </div>
                                                                            <div class="pl-15 mb-30"><a href="#" class="file-control active">المعماري</a> <a href="#" class="file-control">الانشائي</a> <a href="#" class="file-control">الميكانيكا</a> <a href="#" class="file-control">الكهرباء</a> <a
                                                                                        href="#" class="file-control">الموقع العام</a></div>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table id="pro_list" class="table table-hover display  pb-30">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>مساحي</td>
                                                                                            <td>24-08-2018</td>
                                                                                            <td>بناءا علي اوامر المالك</td>
                                                                                            <td>امر تغغير الاحواض</td>
                                                                                            <td><a href="_singlepro.php?pronum=3">
                                                                                                    <button class="btn btn-info"></button>
                                                                                                </a></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>مساحي</td>
                                                                                            <td>24-08-2018</td>
                                                                                            <td>حاجه فنيه في المشروع</td>
                                                                                            <td>امر تغغير بلاط الارضيات</td>
                                                                                            <td><a href="_singlepro.php?pronum=3">
                                                                                                    <button class="btn btn-info"></button>
                                                                                                </a></td>
                                                                                        </tr>
